                ...
                <div className="requirement-item">
                  ...
                  {cat === 'ESP' && espStages.length > 0 ? (
                    ...
                    <div className="progress-bar el-bar-composite">
                      ...
                      {(elUpperCount >= 2 || elUpperCount + plannedElUpper >= 2) && (
                        <div className={`el-zone-slot ${elUpperCount >= 2 ? 'done' : 'planned'}`}
                  ...
                  <div className="credits-col">
                    <span className="credits-text" style={{ color: isDark ? '#c8c8d0' : (met ? color : '#555') }}>
                      {cat === 'ESP'
                        ? `${got} / ${req}학점`
                        : cat === 'EL'
                          ? <>{got}{plannedElCredits > 0 && <span className="planned-count">+{plannedElCredits}</span>} / {req}학점</>
