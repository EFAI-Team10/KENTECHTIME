...
export const scheduleAPI = {
  ...
  getPastSemesters: () => api.get('/schedule/past'),
  getPast: (semester) => api.get(`/schedule/past?semester=${semester}`),
};
...
export const coursesAPI = {
  ...
  setGradIncluded: (courseId, gradIncluded) => api.patch('/courses/completed', { courseId, grad_included: gradIncluded }),
...
export const usersAPI = {
  ...
  ackSemester: (ack_semester) => api.patch('/users/me', { ack_semester }),
