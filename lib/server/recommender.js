...
export async function generateRecommendations(userId, _semester, preferences = {}, n = 3, intent = null, maxCredits = 16) {
  const { mandatory, elective, userGrade, elUpperCount, earnedByCat } = await getRequiredCourses(userId, preferences);
  ...
  let filteredMandatory = eligibleMandatory;
  let filteredElective  = eligibleElective;
